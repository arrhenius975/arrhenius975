...
### Projects:
-[Devdroid-ROM](https://github.com/arrhenius975/Devdroid-ROM): Devdroid-ROM(https://github.com/arrhenius975/Devdroid-ROM): a custom AOSP-based ROM offering a secure, integrated development environment. It includes a built-in Bash shell, Python interpreter, and GCC/Clang toolchain, enabling seamless coding, compiling, and
